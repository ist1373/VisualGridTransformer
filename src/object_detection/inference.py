...
def process_bounding_boxes(image_root,grid_root,image_name,output_root,dataset,config_file, high_res_img_path = None,opts=[]):
    ...
    cfg.MODEL.WEIGHTS = "/Users/imansaberi/Documents/research_projects/content_extraction/VGT/model/publaynet_VGT_model.pth"
    ...
    serialize_outputs = serialize_instances(output)
    ...
    if high_res_img_path:
        ...
        serialize_outputs = serialize_instances(output,scale=scale)
